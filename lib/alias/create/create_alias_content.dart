...
class CreateAliasContent extends StatefulWidget {
  ...
  const CreateAliasContent({super.key, required this.mailboxes});
...
class _CreateAliasContentState extends State<CreateAliasContent> {
  ...
  void initState() {
    ...
    aliasController = TextEditingController(
      text:
          "${randomNames.name().toLowerCase()}.${randomNames.surname().toLowerCase()}",
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Create Alias")),
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  labelText: 'Address',
                  helperText: "@maxlu.cloud will be added",
                ),
              ),
